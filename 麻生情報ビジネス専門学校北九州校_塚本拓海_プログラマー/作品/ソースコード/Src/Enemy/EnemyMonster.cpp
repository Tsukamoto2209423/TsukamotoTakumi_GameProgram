...
namespace BOUDAMA
{
	...
	void EnemyMonster::Init(void)
	{
		...
		stateMachine_->AddState<StraightAttack>(ENEMY_STATE::ATTACK, ENEMY_STATE::RANDOM_WALK, MONSTER::ATTACK_SPEED, MONSTER::ATTACK_MAX_TIME);
		stateMachine_->AddState<KnockBack>(ENEMY_STATE::KNOCK_BACK, ENEMY_STATE::RANDOM_WALK);
		stateMachine_->AddState<Corpse>(ENEMY_STATE::CORPSE, ENEMY_STATE::RANDOM_WALK);
