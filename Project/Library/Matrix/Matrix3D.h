...
public:
	...
	*/
	static Matrix3D GetPitchMatrix(float rotationValue)
	{
		...
		pitchMat.m[5] = cosf(rotationValue); pitchMat.m[6] = -sinf(rotationValue); pitchMat.m[9] = sinf(rotationValue); pitchMat.m[10] = cosf(rotationValue);
	...
	*/
	static Matrix3D GetYawMatrix(float rotationValue)
	{
		...
		yawMat.m[0] = cosf(rotationValue); yawMat.m[2] = sinf(rotationValue); yawMat.m[8] = -sinf(rotationValue); yawMat.m[10] = cosf(rotationValue);
		return yawMat;
	}
	...
	*/
	static Matrix3D GetRollMatrix(float rotationValue)
	{
		...
		rollMat.m[0] = cosf(rotationValue); rollMat.m[1] = -sinf(rotationValue); rollMat.m[4] = sinf(rotationValue); rollMat.m[5] = cosf(rotationValue);
